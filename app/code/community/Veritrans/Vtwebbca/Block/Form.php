 ...
 */
class Veritrans_Vtwebbca_Block_Form extends Mage_Payment_Block_Form
{
    ...
    // }
    // if (Mage::getStoreConfig('payment/vtweb/enable_bcaclickpay') == '1') {
    //   $direct_debit[] = 'bca_clickpay';
    // }
    // if (Mage::getStoreConfig('payment/vtweb/enable_briepay') == '1') {
    //   $direct_debit[] = 'bri_epay';
    // }
    // if (Mage::getStoreConfig('payment/vtweb/enable_bcabill') == '1') {
    ...
    // }
		...
		$this->setFormMessage(Mage::helper('vtwebbca/data')->_getFormMessage());
        $this->setTemplate('vtwebbca/form.phtml');
    }
}
?>
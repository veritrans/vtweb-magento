...
class Veritrans_Vtwebbca_PaymentController
  ...
  public function redirectAction() {
    ...
    Veritrans_Config::$isProduction =
        Mage::getStoreConfig('payment/vtwebbca/environment') == 'production'
        ? true : false;

    Veritrans_Config::$serverKey =
        Mage::getStoreConfig('payment/vtwebbca/server_key');
    ...
    $payloads['vtweb']['credit_card'] = $credit_card;

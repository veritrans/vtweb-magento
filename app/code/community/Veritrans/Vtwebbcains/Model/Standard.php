 ...
 */
class Veritrans_Vtwebbcains_Model_Standard extends Mage_Payment_Model_Method_Abstract {
	protected $_code = 'vtwebbcains';
	
	protected $_isInitializeNeeded      = true;
	protected $_canUseInternal          = true;
	protected $_canUseForMultishipping  = false;
	
	protected $_formBlockType = 'vtwebbcains/form';
	protected $_infoBlockType = 'vtwebbcains/info';
	
	// call to redirectAction function at Veritrans_Vtweb_PaymentController
	public function getOrderPlaceRedirectUrl() {
		return Mage::getUrl('vtwebbcains/payment/redirect', array('_secure' => true));
	}
}
?>
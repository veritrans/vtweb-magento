 ...
 */
class Veritrans_Vtwebio_Block_Form extends Mage_Payment_Block_Form
{
    ...
    protected function _construct()
    {
		...
		$this->setFormMessage(Mage::helper('vtwebio/data')->_getFormMessage());
        $this->setTemplate('vtwebio/form.phtml');
    }
}
?>
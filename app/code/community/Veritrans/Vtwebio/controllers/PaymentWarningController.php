<?php
  class Veritrans_Vtwebio_PaymentWarningController extends Mage_Core_Controller_Front_Action {
    public function warningAction() {
      ...
      if ($message == 1) {
        ...
        Mage::getSingleton('core/session')->addWarning('Sorry, we are unable to proceed your transaction with installment.<br>
          Transaction with installment is only allowed for transaction amount above Rp' . $threshold . ' .<br><br>
          <a href="' . $data .'">Click here to continue with full payment</a>');
      }
